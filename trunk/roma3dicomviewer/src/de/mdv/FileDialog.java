...
public class FileDialog extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		selectButton.setOnClickListener(new OnClickListener() { public void onClick(View v) {
		...
		newButton.setOnClickListener(new OnClickListener() { public void onClick(View v) {
				setCreateVisible(v);
		...
		cancelButton.setOnClickListener(new OnClickListener() { public void onClick(View v) {
				setSelectVisible(v);
			}

		});
		final Button createButton = (Button) findViewById(R.id.fdButtonCreate);
		createButton.setOnClickListener(new OnClickListener() { public void onClick(View v) {
